...
void Loop()
{
  ...
  int nfile = 0;
  /*nfile += chain->Add("pythia_tree_Oct14_1.root");
  nfile += chain->Add("pythia_tree_Oct14_2.root");
  nfile += chain->Add("pythia_tree_Oct15_1.root");
  nfile += chain->Add("pythia_tree_Oct15_2.root");*/
  nfile += chain->Add("pythia_tree_Oct15_3.root");
  nfile += chain->Add("pythia_tree_Oct15_4.root");
  nfile += chain->Add("pythia_tree_Oct15_5.root");
  nfile += chain->Add("pythia_tree_Oct15_6.root");
